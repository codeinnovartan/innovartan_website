    ...
    <div className="bg-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-40 lg:py-4  w-full font-metropolis">
      <div className=" bg-gradient-to-b from-[#001A44] to-[#002A6C] text-white px-10 py-4 md:px-12 flex flex-col md:flex-row lg:flex-row items-center justify-between rounded-2xl shadow-lg">
        ...
        <div className="flex gap-4 flex-col lg:flex-row md:flex-row ">
           <button className="inline-flex  items-center text-base font-medium gap-2 lg:bg-[#0743A3] md:bg-[#0743A3] text-white px-6 py-3 rounded-full bg-[#F36421] hover:text-[#F36421] hover:bg-transparent hover:border hover:border-[#F36421] transition ease-in duration-300">
           Let&apos;s Connect
              <IoIosArrowForward  className="w-4 h-4"/>
            </button>
          <button className="lg:inline-flex items-center text-base bg-[#F36421] font-medium gap-2  text-white px-6 py-3 rounded-full hidden  hover:text-[#F36421] hover:bg-transparent hover:border hover:border-[#F36421] transition ease-in duration-300">
            Schedule a Call
            <IoIosArrowForward  className="w-4 h-4"/>
          </button>
        </div>
