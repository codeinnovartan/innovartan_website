    ...
    <nav className="bg-white shadow-md sticky  top-0 z-50 font-metropolis">
      <div className="flex justify-between items-center mx-auto px-4 sm:px-6  max-w-7xl lg:px-8 py-6">
        ...
        <div className="hidden lg:flex space-x-4 text-base font-medium font-metropolis">
          ...
          <button className="bg-[#0743A3] text-white px-4 py-2 rounded-xl hover:text-[#0743A3] hover:border hover:border-[#0743A3] hover:bg-transparent transition ease-in duration-300" onClick={() => {
            window.location.href = "https://tests.innovartan.com"
          }} >
            Login/Signup
          </button>
        </div>
