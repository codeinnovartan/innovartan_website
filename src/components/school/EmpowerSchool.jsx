  ...
  return (
    <div className="bg-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 font-metropolis">
      <section className="bg-[#FFF5EF]  rounded-2xl flex flex-col-reverse py-4 md:flex-row items-center md:items-stretch ">
        <div className="flex flex-col justify-center items-center md:items-start w-full lg:w-[40%] py-8 md:py-12  md:pl-12">
          <h2 className="text-base md:text-2xl lg:text-[32px] lg:leading-[40px] font-bold mb-4 text-center md:text-left ">
          Ready to Empower Your 
            <span className="text-[#F36421] ml-2 md:ml-3">School?</span>
          </h2>
