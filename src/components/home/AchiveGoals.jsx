    ...
    <>
      <div className="bg-white flex flex-col md:flex-row items-center gap-12 max-h-screen font-metropolis max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:-mt-10">
        ...
        <div className="text-center md:text-left flex-1 lg:w-[40%] ">
          <h1
            className="text-xl md:text-3xl lg:text-[40px] lg:leading-[48px] font-bold  -mt-10 lg:-mt-0
          "
          >
          ...
          <div className="w-full max-md:flex items-center justify-center">
            <button
              ...
              className=" flex justify-center items-center mt-6 bg-[#073278] text-white px-8 py-3 rounded-xl text-sm font-medium shadow-md hover:text-[#073278] hover:bg-transparent hover:border hover:border-[#073278] transition ease-in duration-300 "
            >
