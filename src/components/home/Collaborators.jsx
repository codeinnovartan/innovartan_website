    ...
    <section className="w-full bg-white py-3 lg:my-12 px-6  lg:px-36 font-metropolis">
      <div className="mx-auto flex flex-col lg:flex-row items-center justify-between bg-gradient-to-r from-[#E7EDF6] to-[#f1f5fb] rounded-xl py-10 lg:py-6 lg:px-12">
        <div className="w-full lg:w-[40%] lg:text-left text-center">
          ...
          <button className="hidden md:inline-flex justify-center items-center gap-2 text-[#0743A3] mt-4 py-3 px-4 rounded-full border border-1 w-44 border-[#0743A3] font-medium text-base md:text-base">
            Learn More
        ...
        <button className="md:hidden inline-flex justify-center items-center gap-2 text-[#0743A3] mt-4 py-3 px-4 rounded-full border border-1 w-44 border-[#0743A3] font-medium text-base md:text-base">
          Know More
          <IoIosArrowForward className="w-4 h-4 flex-shrink-0" />
        </button>
      </div>
